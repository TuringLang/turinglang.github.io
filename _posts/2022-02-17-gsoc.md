...
It's another year of the [Google Summer of Code](https://summerofcode.withgoogle.com/) time and we've compiled an updated list of exciting Turing proects!
Below is a list of projects the Turing team would be interested in working with students on for the summer.
This information is also cross-posted at [Julia's Turing project page](https://julialang.org/jsoc/gsoc/turing/).

If you are interested in exploring any of these projects or have any question, please reach out to the listed project mentors. 
