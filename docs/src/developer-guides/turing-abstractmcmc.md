# Turing x AbstractMCMC

This document describes how Turing implements AbstractMCMC.

Prerequisite: [Sampling Interface](/docs/developer-guides/sampling-interface/).
